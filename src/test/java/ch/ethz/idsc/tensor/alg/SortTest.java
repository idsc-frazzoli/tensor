...
public class SortTest extends TestCase {
  public void testSort() {
    ...
    assertEquals(Sort.of(m, RealScalarComparators.DESCENDING), Tensors.vectorDouble(.5, .4, .2, 0, -.3));
    assertEquals(Sort.of(m), Sort.of(m, RealScalarComparators.ASCENDING));
  }
}
