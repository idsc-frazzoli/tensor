...
public class AbstractContinuousDistributionTest extends TestCase {
  public void testSimple() {
    ...
    // Distribution d2 = NormalDistribution.of(1, 2);
    Distribution d3 = NormalDistribution.of(1, 3);
    Distribution d4 = BinomialDistribution.of(3, RealScalar.of(.2));
    // assertEquals(d1, d2);
  ...
  public void testHistogram() {
    ...
    // Distribution d2 = HistogramDistribution.of(Tensors.vector(1.2, .3, .11, 2.2, 1.4, 5.0, 1.23, 0.1));
    Distribution d3 = NormalDistribution.of(1, 3);
    // assertEquals(d1, d2);
    assertFalse(d1.equals(d3));
