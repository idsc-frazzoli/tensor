...
public class DistributionTest extends TestCase {
  private static void _check(Distribution distribution, int samples) {
    ...
    for (int c = 0; c < samples; ++c) {
      collect.append(RandomVariate.of(distribution));
    }
  ...
  public void testSimple() {
    ...
    _check(ExponentialDistribution.of(RealScalar.of(2.5)), 1000);
    _check(GeometricDistribution.of(RealScalar.of(0.7)), 2000);
