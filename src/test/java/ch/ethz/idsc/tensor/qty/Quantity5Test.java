...
public class Quantity5Test extends TestCase {
  ...
  public void testMatrixExp3() {
    ...
    Scalar qs4 = Quantity.of(RealScalar.of(5), "[s]");
  ...
  public void testQuantile() {
    ...
    Scalar qs4 = Quantity.of(RealScalar.of(2), "[s]");
    try {
  ...
  public void testInterpolation() {
    ...
    Scalar r = Quantity.of(RealScalar.of((1 + 4) * 0.5), "[m]");
  ...
  public void testInterpolation2() {
    ...
    Tensor v2;
    {
      Scalar qs1 = Quantity.of(RealScalar.of(9), "[s]");
      Scalar qs2 = Quantity.of(RealScalar.of(6), "[s]");
      Scalar qs3 = Quantity.of(RealScalar.of(-3), "[s]");
    ...
    Scalar r1 = Quantity.of(RealScalar.of((1 + 4) * 0.5), "[m]");
    Scalar r2 = Quantity.of(RealScalar.of((9 + 6) * 0.5), "[s]");
