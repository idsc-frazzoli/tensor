...
public class ArgMinTest extends TestCase {
  ...
  public void testMinComparator() {
    assertEquals(1, ArgMin.of(Tensors.vectorDouble(3., .6, 8, .6, 100), RealScalar.comparatorAscending));
    assertEquals(2, ArgMin.of(Tensors.vectorDouble(3, 3., .6, 8, .6, 8), RealScalar.comparatorAscending));
  }
}
