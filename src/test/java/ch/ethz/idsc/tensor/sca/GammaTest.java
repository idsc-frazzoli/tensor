...
public class GammaTest extends TestCase {
  ...
  public void testValue() {
    assertTrue(Chop._07.close(Gamma.of(RealScalar.of(3.2)), RealScalar.of(2.4239654799353683)));
    assertTrue(Chop._07.close(Gamma.of(RealScalar.of(7.9)), RealScalar.of(4122.709484285446)));
  }

  public void testNegative() {
    assertTrue(Chop._07.close(Gamma.of(RealScalar.of(-2.1)), RealScalar.of(-4.626098277572807)));
  }

  public void testComplex1() {
    Scalar result = Gamma.of(ComplexScalar.of(1.1, 0.3));
    Scalar actual = ComplexScalar.of(0.886904759534451, -0.10608824042449128);
    assertTrue(Chop._08.close(result, actual));
  }
